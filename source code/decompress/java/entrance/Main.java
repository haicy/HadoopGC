...
public class Main {
    ...
    private static final int sec_seq_num = 45; //the reference sequence number used for the second-level compression

    private static String identifier;
    private static int lineWidth, seq_code_len, seq_low_len, nCha_len, spe_cha_len, seqNumber;

    private static final char []ref_code=new char[MAX_CHA_NUM];
    private static final char []seq_code=new char[MAX_CHA_NUM];
    private static int []low_loc= new int[VEC_SIZE/2];   //lowercase location
    ...
    private static List <MatchEntry> matchResult;                 //stores the first-level matched result
        ...
        try {
                ...
                if (flag!=1){
                    ...
                    if(low_loc!=null)
                        ...
                        seq_low_len = 0;
                    int diff_low_len = Integer.parseInt(br.readLine());
    ...
    private static void readTargetSequenceCode(List <MatchEntry> _mr) {
        ...
        for (int i = 0; i < _mr.size();i++) {
            ...
            //recover misStr first, and then matchentity, be in accordance with compression
    ...
    private static void decompress(String refPath, String namePath,String filePath ,String outPath) {
        ...
        try {
            ...
            for (int i = 0; i < seqNumber; i++) {
                //read the to-be-decompressed files
    ...
    public static void main(String[] args) throws Exception {
        String input_ref = args[0];//reference sequence
        String input_filePath = args[1];//compressed file (.bsc)
        String output_Path = args[2];//decompressed file path
